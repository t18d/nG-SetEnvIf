...
The focus being on performance, no logging facility is provided in addition to httpd's native logs. And the plan is to remove backreferences and use non-capturing parentheses exclusively to minimise memory footprint. **Use mod_rewrite for [testing](https://perishablepress.com/ng-firewall-logging/) before deploying nG-SetEnvIf.**
